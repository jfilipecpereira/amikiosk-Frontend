                    ...
                    <div className="cardsContainer cardImage">
                        <div className="miniCard">
                            <div className="miniCardContent">
                                ...
                                <p> <span className="expirationDateText">Validade:</span> 31/05/2021</p>
                                <p><span className="expirationDateText">Origem:</span> Carvalhinhos</p>
                                <p style={{margin:'0'}} ><span className="expirationDateText">Destino:</span> Braga</p>
                            </div>
                        </div>
                        <div className="miniCard">
                            <div className="miniCardContent">
